...
import ejemplo.cajero.control.ComandoGenerarAuditoria;
import ejemplo.cajero.control.ComandoImprimirOperaciones;
...
public class Cajero {
	...
	public static void getOpcionConfigurada() {
	...
	private static List<Comando> cargaComandos() {
		...
		if(opciones.getProperty("consignar", "false").equals("true"))
			comandos.add(new ComandoConsignar());
		if(opciones.getProperty("transferir", "false").equals("true"))
			comandos.add(new ComandoTransferir());
		comandos.add(new ComandoImprimirOperaciones());
		if(opciones.getProperty("generar_auditoria", "false").equals("true"))
			comandos.add(new ComandoGenerarAuditoria());
